Here is the updated documentation including the note about the **V2 branch** for message read/sent status tracking.
...
> 💡 **Tip:** Select the branch **`V2`** if you want message read/sent status indicators to be displayed in your chat application.
